...
strength <- c(2, 0, 0, 0, 0, 2, 0, 1, 0)
dexterity <- c(2, 0, 0, 0, 0, 2, 0, 1, 0)
constitution <- c(0, 2, 0, 0, 0, 1, 0, 1, 0)
wisdom <- c(0, 0, 0, 0, 0, 0, 0, 1, 0)
intelligence <- c(0, 0, 0, 2, 0, 0, 0, 1, 1)
charisma <- c(1, 0, 0, 0, 2, 0, 0, 1, 2)
random1 <- c(0, 0, 0, 0, 1, 0, 0, 0, 0)
random2 <- c(0, 0, 0, 0, 1, 0, 0, 0, 0)
